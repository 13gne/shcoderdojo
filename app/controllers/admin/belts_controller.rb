module Admin
  class BeltsController < AdminBaseController
    ...
    def destroy
      @belt.destroy
      respond_to do |format|
        format.html { redirect_to admin_belts_url, notice: 'Belt was successfully destroyed.' }
    ...
    private
      ...
      def belt_params
        params.require(:belt).permit(:name, :sequence)
      end
  end
end
